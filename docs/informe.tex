...
\and
\IEEEauthorblockN{Elmer José Manuel Villegaz Suárez}
\IEEEauthorblockA{\textit{Departamento de computación} \\
\textit{Universidad de Ingeniería y Tecnología} \\
Lima, Perú \\
...
\begin{enumerate}
    ...
    \item \textbf{Modelos}: \textit{baseline} de regresión logística, SVM, XGBoost, redes neuronales (MLP) y ensemble por promedio de probabilidades. Las redes neuronales se incluyen por su capacidad de capturar interacciones no lineales entre las cuotas de mercado, la calidad de plantilla y las \textit{rolling features} con salida \textit{softmax} sobre las tres clases.
